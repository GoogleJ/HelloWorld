...
public class Constant {
    ...
    //阿里OSS上传地址
    public static final String OSS_URL = "https://zhongxingjike2.oss-accelerate.aliyuncs.com/upload/";  //release
    public static final String BASE_URL = "https://api.hilamg.com";  //release
