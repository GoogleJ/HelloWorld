...
//                } else if (!buyPatterns.equals("CNY") && Float.parseFloat(String.valueOf(etPurchaseAmount.getText())) < (Float.parseFloat(minimum) / Float.parseFloat(getQuickTickerResponse.get(0).getOtc_active().getPrice()))) {
//                    ToastUtils.showShort(getString(R.string.buy_amount_prompt2, String.valueOf(Float.parseFloat(minimum) / Float.parseFloat(getQuickTickerResponse.get(0).getOtc_active().getPrice())), currency));
//                } else {
//
...
//
//                    adapter.setNewData(getQuickTickerResponse);
//
//                }
//            }
//        });
...
//        tvPrice.setText(price + "\u0020" + getQuickTickerResponse.get(position).getOtc_active().getCurrency_type() + "/" + getQuickTickerResponse.get(position).getOtc_active().getCurrency());
//        TextView tvAmount = byCoinsOrAmount.findViewById(R.id.tv_amount);
//        tvAmount.setText(amount + "\u0020" + getQuickTickerResponse.get(position).getOtc_active().getCurrency());
//        TextView tvTotal = byCoinsOrAmount.findViewById(R.id.tv_total);
//        tvTotal.setText(total + "\u0020" + getQuickTickerResponse.get(position).getOtc_active().getCurrency_type());
...
//        if (tvBuyPatterns.getText().equals("CNY")) {
//
//            String secret = "active_id=" + getQuickTickerResponse.get(0).getOtc_active().getActive_id() +
//                    "&by_cny=" + etPurchaseAmount.getText().toString() +
//                    "&currency=" + currency +
//                    "&nonce=" + timestamp +
//                    "&price=" + getQuickTickerResponse.get(0).getOtc_active().getPrice() +
...
//                            timestamp,
//                            getQuickTickerResponse.get(0).getOtc_active().getPrice(),
...
//        price = getQuickTickerResponse.get(position).getOtc_active().getPrice();//单价
//
//        DecimalFormat df4 = new DecimalFormat("###.00");
//
//        if (buyPatterns.equals("CNY")) {
//            amount = Double.parseDouble(nf.format(Float.parseFloat(String.valueOf(etPurchaseAmount.getText())) / Float.parseFloat(getQuickTickerResponse.get(position).getOtc_active().getPrice())).replace(",", ""));
...
//            total = Double.parseDouble(df4.format(Double.parseDouble(String.valueOf(etPurchaseAmount.getText())) * Double.parseDouble(getQuickTickerResponse.get(position).getOtc_active().getPrice())).replace(",", ""));
//        }
//    }
}