...
public class KeyboardPopupWindow extends PopupWindow {
    ...
    private void initView() {
        ...
        parentView.findViewById(R.id.tvTitle).setVisibility(View.GONE);
        parentView.findViewById(R.id.llContainer).setVisibility(View.GONE);

        View viewById = parentView.findViewById(R.id.dropdownLl);
        viewById.setVisibility(View.VISIBLE);
        viewById.setOnClickListener(view -> dismiss());
    ...
    private void initKeyboardView(View view) {
        ...
        //③给叉按键设置点击监听
        view.findViewById(R.id.buttonCross).setOnClickListener(v -> {
            int length = editText.getText().toString().length();
            int curSelection = editText.getSelectionStart();
