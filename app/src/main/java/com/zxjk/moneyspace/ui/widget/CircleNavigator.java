...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        if (mCirclePoints.size() > 0) {
            canvas.drawLine(mIndicatorX, (int) (getHeight() / 2.0f + 0.5f), mIndicatorX - mCircleSpacing / 2, (getHeight() / 2.0f + 0.5f), mPaint);
            canvas.drawLine(mIndicatorX, (int) (getHeight() / 2.0f + 0.5f), mIndicatorX + mCircleSpacing / 2, (getHeight() / 2.0f + 0.5f), mPaint);
        }
    }
    ...
    private void prepareCirclePoints() {
        ...
        if (mTotalCount > 0) {
            ...
            float centerSpacing = mRadius * 2 + mCircleSpacing;
            float startX = mCircleSpacing / 2f + mRadius;
