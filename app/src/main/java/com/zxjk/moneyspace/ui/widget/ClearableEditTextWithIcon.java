 ...
 */
public class ClearableEditTextWithIcon extends AppCompatEditText implements View.OnTouchListener, TextWatcher,View.OnFocusChangeListener{
    ...
    public void clickRightBtn(){
        if(rightType == TYPE_RIGHT_DEL){
            ...
            if(this.getTransformationMethod() == PasswordTransformationMethod.getInstance()){
                ...
                setDeleteImage(R.drawable.password_hint);
            }else{
                this.setTransformationMethod(PasswordTransformationMethod.getInstance());
                setDeleteImage(R.drawable.password_show);
            }
            this.postInvalidate();
        }
    }
    ...
    public void setRightBtnType(int type){
        ...
        if(rightType == TYPE_RIGHT_EYE){
            ...
            setDeleteImage(R.drawable.icon_edit_delete);
        }
    }
