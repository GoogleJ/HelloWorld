        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
          if (PhotoViewAttacher.this.mSingleFlingListener != null) {
            if (PhotoViewAttacher.this.getScale() > 1.0F) {
              ...
              return MotionEventCompat.getPointerCount(e1) <= PhotoViewAttacher.SINGLE_TOUCH && MotionEventCompat.getPointerCount(e2) <= PhotoViewAttacher.SINGLE_TOUCH ? PhotoViewAttacher.this.mSingleFlingListener.onFling(e1, e2, velocityX, velocityY) : false;
            }
          } else {
            return false;
          }
