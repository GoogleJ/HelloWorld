...
public class SubsamplingScaleImageView extends View {
    ...
    private Map<Integer, List<SubsamplingScaleImageView.Tile>> tileMap;
    ...
    public final void setBitmapAndFileUri(Bitmap bitmap, Uri fileUri) {
        ...
        if (bitmap != null && bitmap.getWidth() < maxLoader && bitmap.getHeight() < maxLoader) {
            ...
            this.setMaxScale(10.0F * scaleMax);
            this.setDoubleTapZoomScale(scaleMax * 2.0F);
        ...
        if (imageSource == null) {
            ...
            if (previewSource != null) {
                ...
                if (previewSource.getBitmap() != null) {
                    ...
                    SubsamplingScaleImageView.BitmapLoadTask task = new SubsamplingScaleImageView.BitmapLoadTask(this, this.getContext(), this.bitmapDecoderFactory, uri, true);
                    this.execute(task);
                }
            }
            ...
            if (imageSource.getBitmap() != null && imageSource.getSRegion() != null) {
                ...
                if (!imageSource.getTile() && this.sRegion == null) {
                    SubsamplingScaleImageView.BitmapLoadTask task = new SubsamplingScaleImageView.BitmapLoadTask(this, this.getContext(), this.bitmapDecoderFactory, this.uri, false);
                    this.execute(task);
                } else {
                    SubsamplingScaleImageView.TilesInitTask task = new SubsamplingScaleImageView.TilesInitTask(this, this.getContext(), this.regionDecoderFactory, this.uri);
                    this.execute(task);
                }
            }
    ...
    private void reset(boolean newImage) {
        ...
        if (this.tileMap != null) {
            ...
            while (var2.hasNext()) {
                Entry<Integer, List<SubsamplingScaleImageView.Tile>> tileMapEntry = (Entry) var2.next();
                Iterator var4 = ((List) tileMapEntry.getValue()).iterator();

                while (var4.hasNext()) {
                    SubsamplingScaleImageView.Tile tile = (SubsamplingScaleImageView.Tile) var4.next();
                    tile.visible = false;
                    if (tile.bitmap != null) {
                        tile.bitmap.recycle();
                        tile.bitmap = null;
        ...
        this.detector = new GestureDetector(context, new SimpleOnGestureListener() {
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                if (SubsamplingScaleImageView.this.panEnabled && SubsamplingScaleImageView.this.readySent && SubsamplingScaleImageView.this.vTranslate != null && e1 != null && e2 != null && (Math.abs(e1.getX() - e2.getX()) > 50.0F || Math.abs(e1.getY() - e2.getY()) > 50.0F) && (Math.abs(velocityX) > 500.0F || Math.abs(velocityY) > 500.0F) && !SubsamplingScaleImageView.this.isZooming) {
                    ...
                    float sCenterXEnd = ((float) SubsamplingScaleImageView.this.getWidth() / 2.0F - vTranslateEnd.x) / SubsamplingScaleImageView.this.scale;
                    float sCenterYEnd = ((float) SubsamplingScaleImageView.this.getHeight() / 2.0F - vTranslateEnd.y) / SubsamplingScaleImageView.this.scale;
                    (SubsamplingScaleImageView.this.new AnimationBuilder(new PointF(sCenterXEnd, sCenterYEnd))).withEasing(1).withPanLimited(false).withOrigin(3).start();
                    return true;
                } else {
                    ...
                    if (touchCount >= 2) {
                        ...
                        if (this.zoomEnabled && (this.distance(this.vCenterStart.x, dy, this.vCenterStart.y, offset) > 5.0F || Math.abs(dx - this.vDistStart) > 5.0F || this.isPanning)) {
                            ...
                            if (this.scale <= this.minScale()) {
                                ...
                                this.vTranslate.x = (float) this.getWidth() / 2.0F - this.scale * this.sRequestedCenter.x;
                                this.vTranslate.y = (float) this.getHeight() / 2.0F - this.scale * this.sRequestedCenter.y;
                            } else {
                                this.vTranslate.x = (float) this.getWidth() / 2.0F - this.scale * ((float) this.sWidth() / 2.0F);
                                this.vTranslate.y = (float) this.getHeight() / 2.0F - this.scale * ((float) this.sHeight() / 2.0F);
                            }
    ...
    private void doubleTapZoom(PointF sCenter, PointF vFocus) {
        ...
        if (this.doubleTapZoomStyle == 3) {
            ...
            if (this.doubleTapZoomStyle == 1) {
                (new SubsamplingScaleImageView.AnimationBuilder(targetScale, sCenter, vFocus)).withInterruptible(false).withDuration((long) this.doubleTapZoomDuration).withOrigin(4).start();
            }
        } else {
            (new SubsamplingScaleImageView.AnimationBuilder(targetScale, sCenter)).withInterruptible(false).withDuration((long) this.doubleTapZoomDuration).withOrigin(4).start();
        }
        ...
        if (this.sWidth != 0 && this.sHeight != 0 && this.getWidth() != 0 && this.getHeight() != 0) {
            ...
            if (this.checkReady()) {
                ...
                if (this.anim != null && this.anim.vFocusStart != null) {
                    ...
                    PointF var10000 = this.vTranslate;
                    var10000.x -= this.sourceToViewX(this.anim.sCenterEnd.x) - vFocusNowX;
                    var10000 = this.vTranslate;
                    var10000.y -= this.sourceToViewY(this.anim.sCenterEnd.y) - vFocusNowY;
                        ...
                        do {
                            if (!var4.hasNext()) {
                                ...
                                while (true) {
                                    ...
                                    while (var18.hasNext()) {
                                        tile = (SubsamplingScaleImageView.Tile) var18.next();
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    do {
                        ...
                        tile = (SubsamplingScaleImageView.Tile) var4.next();
                    } while (!tile.loading && tile.bitmap != null);
    ...
    private void setNewDefaultScale() {
        ...
        if (w1 > 0 && h1 > 0 && w2 > 0 && h2 > 0) {
            float ratioView = (float) w1 * 1.0F / (float) h1;
            float ratioImg = (float) w2 * 1.0F / (float) h2;
            boolean isShowCenter = false;
            float scaleTemp = -1.0F;
            float centerX = -1.0F;
            float centerY = -1.0F;
            if (ratioImg < ratioView) {
                scaleTemp = (float) w1 * 1.0F / (float) w2;
                centerX = (float) h2 / 2.0F;
                centerY = (float) h1 / 2.0F / scaleTemp;
            }

            if (scaleTemp >= 0.0F && centerX >= 0.0F && centerY >= 0.0F) {
    ...
    private synchronized void initialiseBaseLayer(Point maxTileDimensions) {
        ...
        if (this.fullImageSampleSize == 1 && this.sRegion == null && this.sWidth() < maxTileDimensions.x && this.sHeight() < maxTileDimensions.y) {
            ...
            List<SubsamplingScaleImageView.Tile> baseGrid = (List) this.tileMap.get(this.fullImageSampleSize);
            Iterator var3 = baseGrid.iterator();

            while (var3.hasNext()) {
                SubsamplingScaleImageView.Tile baseTile = (SubsamplingScaleImageView.Tile) var3.next();
                SubsamplingScaleImageView.TileLoadTask task = new SubsamplingScaleImageView.TileLoadTask(this, this.decoder, baseTile);
                this.execute(task);
            }
    ...
    private void refreshRequiredTiles(boolean load) {
        if (this.decoder != null && this.tileMap != null) {
            ...
            while (var3.hasNext()) {
                Entry<Integer, List<SubsamplingScaleImageView.Tile>> tileMapEntry = (Entry) var3.next();
                Iterator var5 = ((List) tileMapEntry.getValue()).iterator();

                while (var5.hasNext()) {
                    SubsamplingScaleImageView.Tile tile = (SubsamplingScaleImageView.Tile) var5.next();
                    ...
                    if (tile.sampleSize == sampleSize) {
                        if (this.tileVisible(tile)) {
                            ...
                            if (!tile.loading && tile.bitmap == null && load) {
                                SubsamplingScaleImageView.TileLoadTask task = new SubsamplingScaleImageView.TileLoadTask(this, this.decoder, tile);
                                this.execute(task);
                            }
    ...
    private boolean tileVisible(SubsamplingScaleImageView.Tile tile) {
    ...
    private void preDraw() {
        if (this.getWidth() != 0 && this.getHeight() != 0 && this.sWidth > 0 && this.sHeight > 0) {
            if (this.sPendingCenter != null && this.pendingScale != null) {
                ...
                this.vTranslate.x = (float) this.getWidth() / 2.0F - this.scale * this.sPendingCenter.x;
                this.vTranslate.y = (float) this.getHeight() / 2.0F - this.scale * this.sPendingCenter.y;
                this.sPendingCenter = null;
    ...
    private void fitToBounds(boolean center, SubsamplingScaleImageView.ScaleAndTranslate sat) {
        ...
        if (this.panLimit == 3 && this.isReady()) {
            vTranslate.x = Math.max(vTranslate.x, (float) this.getWidth() / 2.0F - scaleWidth);
            vTranslate.y = Math.max(vTranslate.y, (float) this.getHeight() / 2.0F - scaleHeight);
        } else if (center) {
    ...
    private void initialiseTileMap(Point maxTileDimensions) {
        ...
        while (true) {
            ...
            List<SubsamplingScaleImageView.Tile> tileGrid = new ArrayList(xTiles * yTiles);
    ...
    private float viewToSourceX(float vx) {
        return this.vTranslate == null ? (float) (0.0F / 0.0) : (vx - this.vTranslate.x) / this.scale;
    }

    private float viewToSourceY(float vy) {
        return this.vTranslate == null ? (float) (0.0F / 0.0) : (vy - this.vTranslate.y) / this.scale;
    }
    ...
    private float sourceToViewX(float sx) {
        return this.vTranslate == null ? (float) (0.0F / 0.0) : sx * this.scale + this.vTranslate.x;
    }

    private float sourceToViewY(float sy) {
        return this.vTranslate == null ? (float) (0.0F / 0.0) : sy * this.scale + this.vTranslate.y;
    }
    ...
    public final void getPanRemaining(RectF vTarget) {
        if (this.isReady()) {
            ...
            if (this.panLimit == 3) {
                vTarget.top = Math.max(0.0F, -(this.vTranslate.y - (float) this.getHeight() / 2.0F));
                vTarget.left = Math.max(0.0F, -(this.vTranslate.x - (float) this.getWidth() / 2.0F));
                vTarget.bottom = Math.max(0.0F, this.vTranslate.y - ((float) this.getHeight() / 2.0F - scaleHeight));
                vTarget.right = Math.max(0.0F, this.vTranslate.x - ((float) this.getWidth() / 2.0F - scaleWidth));
    ...
    public SubsamplingScaleImageView.AnimationBuilder animateCenter(PointF sCenter) {
        return !this.isReady() ? null : new SubsamplingScaleImageView.AnimationBuilder(sCenter);
    }

    public SubsamplingScaleImageView.AnimationBuilder animateScale(float scale) {
        return !this.isReady() ? null : new SubsamplingScaleImageView.AnimationBuilder(scale);
    }

    public SubsamplingScaleImageView.AnimationBuilder animateScaleAndCenter(float scale, PointF sCenter) {
        return !this.isReady() ? null : new SubsamplingScaleImageView.AnimationBuilder(scale, sCenter);
    }

    public static class DefaultOnStateChangedListener implements SubsamplingScaleImageView.OnStateChangedListener {
    ...
    public static class DefaultOnImageEventListener implements SubsamplingScaleImageView.OnImageEventListener {
    ...
    public static class DefaultOnAnimationEventListener implements SubsamplingScaleImageView.OnAnimationEventListener {
    ...
    public final class AnimationBuilder {
        ...
        public SubsamplingScaleImageView.AnimationBuilder withInterruptible(boolean interruptible) {
            this.interruptible = interruptible;
            return this;
        }

        public SubsamplingScaleImageView.AnimationBuilder withEasing(int easing) {
            if (!SubsamplingScaleImageView.VALID_EASING_STYLES.contains(easing)) {
        ...
        private SubsamplingScaleImageView.AnimationBuilder withPanLimited(boolean panLimited) {
            this.panLimited = panLimited;
            return this;
        }

        private SubsamplingScaleImageView.AnimationBuilder withOrigin(int origin) {
            this.origin = origin;
            return this;
        }
        ...
        public void start() {
            if (SubsamplingScaleImageView.this.anim != null && SubsamplingScaleImageView.this.anim.listener != null) {
                try {
                    ...
                    Log.w(SubsamplingScaleImageView.TAG, "Error thrown by animation listener", var8);
                }
            }
            ...
            if (this.vFocus != null) {
                float vTranslateXEnd = this.vFocus.x - targetScale * SubsamplingScaleImageView.this.anim.sCenterStart.x;
                float vTranslateYEnd = this.vFocus.y - targetScale * SubsamplingScaleImageView.this.anim.sCenterStart.y;
    ...
    private static class BitmapLoadTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            try {
                ...
                Log.e(SubsamplingScaleImageView.TAG, "Failed to load bitmap", var6);
                this.exception = var6;
            } catch (OutOfMemoryError var7) {
                Log.e(SubsamplingScaleImageView.TAG, "Failed to load bitmap - OutOfMemoryError", var7);
    ...
    private static class TileLoadTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        TileLoadTask(SubsamplingScaleImageView view, ImageRegionDecoder decoder, SubsamplingScaleImageView.Tile tile) {
            this.viewRef = new WeakReference(view);
        ...
        protected Bitmap doInBackground(Void... params) {
            try {
                ...
                Log.e(SubsamplingScaleImageView.TAG, "Failed to decode tile", var11);
                this.exception = var11;
            } catch (OutOfMemoryError var12) {
                Log.e(SubsamplingScaleImageView.TAG, "Failed to decode tile - OutOfMemoryError", var12);
    ...
    private static class TilesInitTask extends AsyncTask<Void, Void, int[]> {
        ...
        protected int[] doInBackground(Void... params) {
            try {
                ...
                Log.e(SubsamplingScaleImageView.TAG, "Failed to initialise bitmap decoder", var10);
