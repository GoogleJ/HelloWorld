...
public class PluginAdapter {
  ...
  public void addPlugins(List<IPluginModule> plugins) {
    for(int i = 0; plugins != null && i < plugins.size(); ++i) {
      IPluginModule pluginModule = (IPluginModule)plugins.get(i);
  ...
  private void initView(Context context, ViewGroup viewGroup) {
    ...
    this.mPluginPager = (ViewGroup)this.mLayoutInflater.inflate(layout.rc_ext_plugin_pager, (ViewGroup)null);
    ...
    this.mViewPager = (ViewPager)this.mPluginPager.findViewById(id.rc_view_pager);
    this.mIndicator = (LinearLayout)this.mPluginPager.findViewById(id.rc_indicator);
  ...
  private class PluginItemAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null) {
        ...
        convertView = PluginAdapter.this.mLayoutInflater.inflate(layout.rc_ext_plugin_item, (ViewGroup)null);
  ...
  private class PluginPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      GridView gridView = (GridView)PluginAdapter.this.mLayoutInflater.inflate(layout.rc_ext_plugin_grid_view, (ViewGroup)null);
