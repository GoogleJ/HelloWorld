      ...
      public void run() {
        if (AlbumBitmapCacheHelper.this.currentShowString.contains(path) && AlbumBitmapCacheHelper.this.cache != null) {
          ...
          if (width != 0 && height != 0) {
            ...
            String tempPath = FileUtils.getInternalCachePath(AlbumBitmapCacheHelper.this.mContext, "image") + "/" + hash + ".temp";
            ...
            if (bitmap == null) {
              ...
              if (bitmap != null) {
                ...
                try {
                  ...
                  RLog.e("AlbumBitmapCacheHelper", "decodeBitmapFromPath", var21);
                } catch (IOException var22) {
                  RLog.e("AlbumBitmapCacheHelper", "decodeBitmapFromPath", var22);
                } finally {
                  if (fos != null) {
                    try {
                      fos.close();
                    } catch (IOException var20) {
                      RLog.e("AlbumBitmapCacheHelper", "decodeBitmapFromPath", var20);
                    }
                  }
            ...
            try {
              ...
              RLog.e("AlbumBitmapCacheHelper", "decodeBitmapFromPath", var24);
            }
          }
  ...
  private Bitmap getBitmap(String path, int widthLimit, int heightLimit) throws OutOfMemoryError {
    ...
    try {
      ...
      if (widthLimit == 0 && heightLimit == 0) {
        sampleSize = this.computeScale(options, ((WindowManager)((WindowManager)this.mContext.getSystemService("window"))).getDefaultDisplay().getWidth(), ((WindowManager)((WindowManager)this.mContext.getSystemService("window"))).getDefaultDisplay().getHeight());
      ...
      try {
        ...
        RLog.e("AlbumBitmapCacheHelper", "getBitmap", var14);
      ...
      if (bitmap != null) {
        ...
        if (widthLimit != 0 && heightLimit != 0) {
          ...
          RLog.e("AlbumBitmapCacheHelper", "widthLimit or heightLimit is 0");
        }

        bitmap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, true);
      }
    } catch (IOException var15) {
      RLog.e("AlbumBitmapCacheHelper", "getBitmap", var15);
    } catch (IllegalArgumentException var16) {
      RLog.e("AlbumBitmapCacheHelper", "getBitmap", var16);
    }
