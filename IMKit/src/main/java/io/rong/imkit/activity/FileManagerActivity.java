...
public class FileManagerActivity extends RongBaseActivity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    this.setContentView(layout.rc_ac_file_manager);
    this.mFileTextView = (TextView)this.findViewById(id.rc_ac_tv_file_manager_file);
    this.mVideoTextView = (TextView)this.findViewById(id.rc_ac_tv_file_manager_video);
    this.mAudioTextView = (TextView)this.findViewById(id.rc_ac_tv_file_manager_audio);
    this.mOtherTextView = (TextView)this.findViewById(id.rc_ac_tv_file_manager_picture);
    this.mMobileMemoryTextView = (TextView)this.findViewById(id.rc_ac_tv_file_manager_mobile_memory);
    this.mSDCardTextView = (TextView)this.findViewById(id.rc_ac_tv_file_manager_SD_card);
    this.mSDCardLinearLayout = (LinearLayout)this.findViewById(id.rc_ac_ll_sd_card);
    this.mSDCardOneLinearLayout = (LinearLayout)this.findViewById(id.rc_ac_ll_sd_card_one);
    this.mSDCardTwoLinearLayout = (LinearLayout)this.findViewById(id.rc_ac_ll_sd_card_two);
    ...
    title.setText(string.rc_ac_file_send_preview);
