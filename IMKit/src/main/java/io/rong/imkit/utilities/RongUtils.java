...
public class RongUtils {
    ...
    public static View getHorizontalThinLine(Context context) {
        ...
        line.setBackgroundColor(context.getResources().getColor(color.rc_divider_line));
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        try {
            ...
            RLog.e(TAG, "getStatusBarHeight", var7);
        }
    ...
    public static Drawable getDrawable(Context context, String resource) {
        ...
        try {
            ...
            RLog.e(TAG, "getDrawable", var16);
        } finally {
            if (is != null) {
                try {
                    is.close();
                } catch (IOException var15) {
                    RLog.e(TAG, "getDrawable", var15);
                }
            }
    ...
    public static Bitmap getResizedBitmap(Context context, Uri uri, int widthLimit, int heightLimit) throws IOException {
        ...
        try {
            ...
            RLog.e(TAG, "getResizedBitmap", var22);
        ...
        if (bitmap == null) {
            ...
            try {
                ...
                RLog.e(TAG, "getResizedBitmap", var21);
