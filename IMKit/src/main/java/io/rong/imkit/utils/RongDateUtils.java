...
public class RongDateUtils {
    ...
    private static String getWeekDay(Context context, int dayInWeek) {
        ...
        switch (dayInWeek) {
            case 1:
                weekDay = context.getResources().getString(string.rc_sunsay_format);
                break;
            case 2:
                weekDay = context.getResources().getString(string.rc_monday_format);
                break;
            case 3:
                weekDay = context.getResources().getString(string.rc_tuesday_format);
                break;
            case 4:
                weekDay = context.getResources().getString(string.rc_wednesday_format);
                break;
            case 5:
                weekDay = context.getResources().getString(string.rc_thuresday_format);
                break;
            case 6:
                weekDay = context.getResources().getString(string.rc_friday_format);
                break;
            case 7:
                weekDay = context.getResources().getString(string.rc_saturday_format);
        }
            ...
            if (isTime24Hour(context)) {
                ...
                if (calendarTime.get(9) == 0) {
                    if (hour < 6) {
                        ...
                        formatTime = context.getResources().getString(string.rc_daybreak_format);
                    } else if (hour >= 6 && hour < 12) {
                        formatTime = context.getResources().getString(string.rc_morning_format);
                    }
                } else if (hour == 0) {
                    formatTime = context.getResources().getString(string.rc_noon_format);
                    hour = 12;
                } else if (hour >= 1 && hour <= 5) {
                    formatTime = context.getResources().getString(string.rc_afternoon_format);
                } else if (hour >= 6 && hour <= 11) {
                    formatTime = context.getResources().getString(string.rc_night_format);
                }
                ...
                case 2014:
                    if (year == yearCur) {
                        if (month == monthCur && weekInMonth == weekInMonthCur) {
                            ...
                            formatDate = formatDate(date, "M" + context.getResources().getString(string.rc_month_format) + "d" + context.getResources().getString(string.rc_day_format));
                        } else {
                            formatDate = formatDate(date, "M/d");
                        }
                    } else if (context.getResources().getConfiguration().locale.getCountry().equals("CN")) {
                        formatDate = formatDate(date, "yyyy" + context.getResources().getString(string.rc_year_format) + "M" + context.getResources().getString(string.rc_month_format) + "d" + context.getResources().getString(string.rc_day_format));
                    } else {
