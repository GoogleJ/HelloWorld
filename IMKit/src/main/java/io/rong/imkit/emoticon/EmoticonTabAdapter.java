...
public class EmoticonTabAdapter {
  ...
  public void refreshTabIcon(IEmoticonTab tab, Drawable drawable) {
    ...
    if (index >= 0) {
      ...
      ImageView iv = (ImageView)child.findViewById(id.rc_emoticon_tab_iv);
  ...
  public void setAddEnable(boolean enable) {
    ...
    if (this.mTabAdd != null) {
      this.mTabAdd.setVisibility(enable ? 0 : 8);
    }
  ...
  public void setSettingEnable(boolean enable) {
    ...
    if (this.mTabSetting != null) {
      this.mTabSetting.setVisibility(enable ? 0 : 8);
    }
  ...
  private View initView(Context context, ViewGroup parent) {
    View container = LayoutInflater.from(context).inflate(layout.rc_ext_emoticon_tab_container, (ViewGroup)null);
    ...
    this.mViewPager = (ViewPager)container.findViewById(id.rc_view_pager);
    this.mScrollTab = (ViewGroup)container.findViewById(id.rc_emotion_scroll_tab);
    this.mTabAdd = container.findViewById(id.rc_emoticon_tab_add);
    ...
    this.mTabSetting = container.findViewById(id.rc_emoticon_tab_setting);
    ...
    LinearLayout tabBar = (LinearLayout)container.findViewById(id.rc_emotion_tab_bar);
  ...
  private View getTabIcon(Context context, Drawable drawable) {
    View item = LayoutInflater.from(context).inflate(layout.rc_ext_emoticon_tab_item, (ViewGroup)null);
    item.setLayoutParams(new LayoutParams(RongUtils.dip2px(60.0F), RongUtils.dip2px(36.0F)));
    ImageView iv = (ImageView)item.findViewById(id.rc_emoticon_tab_iv);
    iv.setImageDrawable(drawable);
  ...
  private void onPageChanged(int pre, int cur) {
    ...
    if (count > 0 && cur < count) {
      ...
      if (cur >= 0) {
        ...
        curView.setBackgroundColor(curView.getContext().getResources().getColor(color.rc_EmoticonTab_bg_select_color));
