...
public class PublicServiceMultiRichContentMessageProvider extends MessageProvider<PublicServiceMultiRichContentMessage> {
    ...
    public View newView(Context context, ViewGroup group) {
        ...
        View view = LayoutInflater.from(context).inflate(layout.rc_item_public_service_multi_rich_content_message, (ViewGroup) null);
        holder.lv = (ListView) view.findViewById(id.rc_list);
        holder.iv = (AsyncImageView) view.findViewById(id.rc_img);
        holder.tv = (TextView) view.findViewById(id.rc_txt);
        view.measure(0, 0);
    ...
    private static class PublicAccountMsgAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View providerConvertView = this.inflater.inflate(layout.rc_item_public_service_message, parent, false);
            AsyncImageView iv = (AsyncImageView) providerConvertView.findViewById(id.rc_img);
            TextView tv = (TextView) providerConvertView.findViewById(id.rc_txt);
            View divider = providerConvertView.findViewById(id.rc_divider);
