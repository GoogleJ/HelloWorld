...
public class AutoRefreshListView extends ListView {
    ...
    private void addRefreshView(Context context) {
        this.refreshHeader = (ViewGroup) View.inflate(context, layout.rc_refresh_list_view, (ViewGroup) null);
        this.addHeaderView(this.refreshHeader, (Object) null, false);
        this.refreshFooter = (ViewGroup) View.inflate(context, layout.rc_refresh_list_view, (ViewGroup) null);
    ...
    private boolean onTouchEventInternal(MotionEvent event) {
        ...
        try {
            ...
            RLog.e(TAG, "onTouchEventInternal catch", var3);
            return false;
        }
    }
    ...
    public boolean isLastItemVisible(int lastVisibleCount) {
        ...
        int lastItemPosition = itemCount - headerViewsCount - 1;
