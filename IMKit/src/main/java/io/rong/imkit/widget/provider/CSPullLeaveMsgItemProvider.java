  ...
  public void bindView(View v, int position, CSPullLeaveMessage csPullLeaveMessage, final UIMessage message) {
    ...
    if (csPullLeaveMessage != null) {
      ...
      if (!TextUtils.isEmpty(content)) {
        ...
        String filter = v.getResources().getString(string.rc_cs_leave_message);
        ...
        if (startPos >= 0) {
          ...
          filterString.setSpan(new ForegroundColorSpan(v.getContext().getResources().getColor(color.rc_voice_color)), 0, filterString.length(), 33);
          filterString.setSpan(new CSPullLeaveMsgItemProvider.Clickable(new OnClickListener() {
