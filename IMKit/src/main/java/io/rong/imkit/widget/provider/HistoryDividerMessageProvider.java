...
public class HistoryDividerMessageProvider extends MessageProvider<HistoryDividerMessage> {
  ...
  public void bindView(View view, int i, HistoryDividerMessage newMessageDivider, UIMessage uiMessage) {
    HistoryDividerMessageProvider.ViewHolder viewHolder = (HistoryDividerMessageProvider.ViewHolder)view.getTag();
  ...
  public View newView(Context context, ViewGroup viewGroup) {
    View view = LayoutInflater.from(context).inflate(layout.rc_item_new_message_divider, (ViewGroup)null);
    HistoryDividerMessageProvider.ViewHolder viewHolder = new HistoryDividerMessageProvider.ViewHolder();
    viewHolder.contentTextView = (TextView)view.findViewById(id.tv_divider_message);
