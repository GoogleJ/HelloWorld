...
public class PublicServiceRichContentMessageProvider extends MessageProvider<PublicServiceRichContentMessage> {
    ...
    public View newView(Context context, ViewGroup group) {
        ...
        View view = LayoutInflater.from(context).inflate(layout.rc_item_public_service_rich_content_message, (ViewGroup)null);
        holder.title = (TextView)view.findViewById(id.rc_title);
        holder.time = (TextView)view.findViewById(id.rc_time);
        holder.description = (TextView)view.findViewById(id.rc_content);
        holder.imageView = (AsyncImageView)view.findViewById(id.rc_img);
