...
public class RongConfigurationManager {
    ...
    public static RongConfigurationManager getInstance() {
        return RongConfigurationManager.SingletonHolder.sInstance;
    }
    ...
    public static void init(Context context) {
        if (!isInit) {
            ...
            context.registerReceiver(new RongConfigurationManager.SystemConfigurationChangedReceiver(), filter);
