...
public class UIConversation implements Parcelable {
  ...
  private UIConversation.UnreadRemindType mUnreadType;
  ...
  public void updateConversation(UserInfo userInfo) {
    if (this.isGathered) {
      ...
      if (this.conversationType == ConversationType.ENCRYPTED) {
  ...
  private UIConversation(Context context) {
    this.mUnreadType = UIConversation.UnreadRemindType.REMIND_WITH_COUNTING;
