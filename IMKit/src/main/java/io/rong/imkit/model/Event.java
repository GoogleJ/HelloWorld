...
public class Event {
  ...
  public static class GroupUserInfoEvent {
    ...
    public static Event.GroupUserInfoEvent obtain(GroupUserInfo info) {
      Event.GroupUserInfoEvent event = new Event.GroupUserInfoEvent();
      event.userInfo = info;
      return event;
    }
  ...
  public static class RecallMessageEditClickEvent extends Event.BaseConversationEvent {
  ...
  public static class ConversationNotificationEvent extends Event.BaseConversationEvent {
    ...
    public static Event.ConversationNotificationEvent obtain(String targetId, ConversationType conversationType, ConversationNotificationStatus conversationNotificationStatus) {
      return new Event.ConversationNotificationEvent(targetId, conversationType, conversationNotificationStatus);
    }
