...
public final class ImageLoaderConfiguration {
  ...
  public static ImageLoaderConfiguration createDefault(Context context, String savePath) {
    return (new ImageLoaderConfiguration.Builder(context)).build(savePath);
  }
  ...
  public static class Builder {
    ...
    /** @deprecated */
    @Deprecated
    public ImageLoaderConfiguration.Builder discCacheExtraOptions(int maxImageWidthForDiskCache, int maxImageHeightForDiskCache, BitmapProcessor processorForDiskCache) {
      return this.diskCacheExtraOptions(maxImageWidthForDiskCache, maxImageHeightForDiskCache, processorForDiskCache);
    }

    public ImageLoaderConfiguration.Builder diskCacheExtraOptions(int maxImageWidthForDiskCache, int maxImageHeightForDiskCache, BitmapProcessor processorForDiskCache) {
    ...
    public ImageLoaderConfiguration build(String savePath) {
      this.initEmptyFieldsWithDefaultValues(savePath);
      return new ImageLoaderConfiguration(this);
    }
    ...
    private void initEmptyFieldsWithDefaultValues(String savePath) {
      ...
      if (this.diskCache == null) {
        ...
        this.diskCache = DefaultConfigurationFactory.createDiskCache(this.context, this.diskCacheFileNameGenerator, this.diskCacheSize, this.diskCacheFileCount, savePath);
      }
